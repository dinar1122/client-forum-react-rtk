      ...
      <div className="flex items-stretch gap-4">
        ...
        <Card className="flex flex-col space-y-4 p-5 flex-1 shadow-sm border">
          <p className="font-semibold">
            <span className="text-gray-500 mr-2">Почта:</span>
            {data.email}
          </p>
          <p className="font-semibold">
            <span className="text-gray-500 mr-2">Город:</span>
            {data.location}
          </p>
          <p className="font-semibold">
            <span className="text-gray-500 mr-2">Дата рождения:</span>
            {formatToClientDate(data.dateOfBirth)}
          </p>
          <p className="font-semibold">
            <span className="text-gray-500 mr-2">Обо мне:</span>
            {data.bio}
          </p>
