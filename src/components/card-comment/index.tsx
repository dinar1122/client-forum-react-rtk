      ...
      <NextUICard className={`mt-4 p-3 z-10 `}>
        <CardHeader className="justify-between items-center bg-transparent pb-0">
          <div>
            <div className="flex-row">
              ...
              {reply && (
                <div
                  onClick={() => setReplyContentShow(!replyContentShow)}
                  className="flex-row ml-3 bg-gray-200 p-2 px-3 rounded-xl cursor-pointer font-semibold"
                >
        ...
        {reply && replyContentShow && (
          <div className="flex-col gap-3 m-3 mb-0 ">
            <div className="bg-gray-200 p-1 px-3 rounded-lg font-semibold italic text-gray-600">
