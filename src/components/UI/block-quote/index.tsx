...
const BlockQuote = ({text}: any) => {
  return (
    <blockquote className="relative mt-4 mb-4 ml-5">
  ...
  <footer className="mt-6">
    <div className="flex items-center">
      ...
      <div className="ms-4">
        <div className="text-base font-semibold text-gray-800 dark:text-neutral-400">Josh Grazioso</div>
        <div className="text-xs text-gray-500 dark:text-neutral-500">Source title</div>
      </div>
    </div>
  </footer>
</blockquote>
